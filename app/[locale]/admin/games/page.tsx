    ...
    <AdminShell locale={locale} labels={dictionary.admin}>
      ...
      <div className="panel overflow-hidden">
        <div className="divide-y divide-white/10">
          {games.map((game) => (
            <div key={game.id} className="flex flex-col gap-4 px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
              <div className="min-w-0">
              ...
              <div className="flex flex-wrap gap-2 lg:justify-end">
                {selectedSquad.id === "a1" && isSupabaseConfigured() ? (
                  <Link
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-white/80 hover:border-gold hover:text-gold"
                  >
                    Anotar
                  </Link>
                ) : null}
